...
| Routineautomatisierung kann Einstiegslernen schwächen. | directional signal | [Jobposting Corpus](../wiki/datasets/jobposting-corpus-2026-05-21.md), [AI in Design Report](../wiki/sources/designer-fund-ai-in-design-report-2026.md) | Keine DACH-Zeitreihe. | 20 weitere Einstiegsrollen codieren. |
...
| Designwert verschiebt sich von Variantenproduktion zu Direction, System, Rechte und QA. | evidence-linked | [Jobposting Corpus](../wiki/datasets/jobposting-corpus-2026-05-21.md), [BLS Web/Digital Designers](../wiki/sources/bls-web-digital-designers-2024-2034.md), [Design Council](../wiki/sources/design-council-design-economy.md) | DACH-Designstellen sind noch zu klein codiert. | 30 Designrollen erreichen. |
...
| Designrollen | 9 | 21 weitere Rollen bis zur ersten Schwelle. |
| Wirtschafts-/Governance-Rollen | 5 | 25 weitere Rollen, Subfelder trennen. |
| Media-/Marketingrollen | 8 | 12 weitere Rollen bis zur ersten Schwelle. |
| Junior/Einstieg | 9 | mindestens 20 Einstiegsrollen für bessere Aussage. |
