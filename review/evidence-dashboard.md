...
| Routineautomatisierung kann Einstiegslernen schwächen. | directional signal | [Jobposting Corpus](../wiki/datasets/jobposting-corpus-2026-05-21.md), [PAGE Corpus](../wiki/datasets/page-stellenmarkt-design-media-corpus-2026-05-22.md), [AI in Design Report](../wiki/sources/designer-fund-ai-in-design-report-2026.md) | Keine DACH-Zeitreihe; PAGE enthält zu wenig enge Junior-Designrollen. | Einstiegsrollen nach [Job Board Watchlist](../wiki/datasets/job-board-watchlist-2026-05-22.md) codieren. |
...
| Designwert verschiebt sich von Variantenproduktion zu Direction, System, Rechte und QA. | evidence-linked | [Jobposting Corpus](../wiki/datasets/jobposting-corpus-2026-05-21.md), [PAGE Corpus](../wiki/datasets/page-stellenmarkt-design-media-corpus-2026-05-22.md), [BLS Web/Digital Designers](../wiki/sources/bls-web-digital-designers-2024-2034.md), [Design Council](../wiki/sources/design-council-design-economy.md) | DACH-Designstellen sind noch zu klein codiert; PAGE ist Creative/Media-Mix. | 50 enge Designrollen aus dasauge, DESIGNERDOCK und Games-Career erreichen. |
...
| Media- und Marketingrollen verlangen stärkere Plattform- und Messkompetenz. | directional signal | [Jobposting Corpus](../wiki/datasets/jobposting-corpus-2026-05-21.md), [PAGE Corpus](../wiki/datasets/page-stellenmarkt-design-media-corpus-2026-05-22.md), [BVDW/OVK](../wiki/sources/bvdw-ovk-prognose-digitaler-werbemarkt-2026.md) | PAGE stärkt Social, Content, Automation und Kommunikation, aber nicht Programmatic in der Breite. | 50 Media-/Marketing-/Plattformrollen aus W&V, kress, turi2 und PAGE adjacent erreichen. |
| Creative-Technology-Rollen werden im DACH-Designmarkt sichtbar. | spot-check signal | [Jobposting Corpus](../wiki/datasets/jobposting-corpus-2026-05-21.md), [PAGE Corpus](../wiki/datasets/page-stellenmarkt-design-media-corpus-2026-05-22.md), [DACH Jobposting Spot Check](../wiki/sources/dach-jobposting-spot-check-2026-05-21.md) | Sichtbarkeit ist kein Wachstum; PAGE zeigt eher Creative/Media-Systemnähe als viele explizite Creative-Technology-Titel. | Zeitvergleich oder aggregierte Jobdaten nachziehen. |
...
| Designrollen | 9 im ersten Corpus plus 9 PAGE-nahe Design/Creative-Rollen | PAGE-Rollen getrennt halten; 50 engere Designrollen bleiben Ziel. |
| Wirtschafts-/Governance-Rollen | 5 | 25 weitere Rollen, Subfelder trennen. |
| Media-/Marketingrollen | 8 im ersten Corpus plus 13 PAGE-Kommunikations-/Redaktionsrollen | Programmatic, Retail Media und Marketing Analytics separat nachziehen. |
| Junior/Einstieg | 9 im ersten Corpus plus wenige PAGE-Einstiegsrollen | Nur enge Einstiegsrollen für Juniorclaim zählen. |
...
4. Jobboard-Watchlist abarbeiten: dasauge, W&V, kress, Tech in Berlin, BiblioJobs, Games-Career.
