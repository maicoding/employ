...
- [Packets](wiki/packets/README.md): kurze Merksätze
- [Operations](wiki/operations/README.md): Such- und Wartungslogik
- [State](wiki/state/dashboard.md): Dashboard, Entscheidungen, Lessons

## Review-Schicht

Die Review-Schicht trennt Aussage, Quelle und Grenze:
...
Diese Dateien steuern Pflege und Updates:

- [Vault Operating System](00_System/Vault_Operating_System.md)
- [Workflows](00_System/workflows.md)
- [Health Check](00_System/health_check.md)
- [Arbeitsmarkt Radar Workflow](05_Playbooks/Arbeitsmarkt_Radar_Workflow.md)
- [Source Refresh Queries](wiki/operations/source-refresh-queries.md)
