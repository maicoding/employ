...
Der Vault hat jetzt ein erstes public-safe Sample mit 22 Rollenmarkern und eine codierte Datenseite: [Jobposting Corpus 2026-05-21](wiki/datasets/jobposting-corpus-2026-05-21.md). Dazu kommt ein getrenntes PAGE-Sample mit 33 Creative/Media-Anzeigen: [PAGE Stellenmarkt Design/Media Corpus 2026-05-22](wiki/datasets/page-stellenmarkt-design-media-corpus-2026-05-22.md). Round 1 ergänzt 101 Titel-/Listing-Marker aus elf Jobboards: [Job Board Sample Round 1](wiki/datasets/job-board-sample-round-1-2026-05-22.md). Die erste Detailcodierung ergänzt 30 Rollen aus sechs Spuren: [Job Detail Coding Round 1](wiki/datasets/job-detail-coding-round-1-2026-05-22.md). Zusammen sind das mehr Ankerpunkte, aber noch kein repräsentatives Korpus.

Nächster Schritt:

- pro Spur 20 direkte Detailseiten erreichen und `snippet-detail` durch `direct-detail` ersetzen
